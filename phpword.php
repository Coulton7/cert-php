...
echo '   <div class="success">
    ...
    <p><div class="cert-footer">Please check the Certificate number and try again, or please <a href="https://www.avtreliability.com/contact-us">contact us</a> for a manual validation.</div><p></p>
   <p>&nbsp;</p>';
...
$data = new Spreadsheet_Excel_Reader_Constructor($userDoc);
return $data->dump($row_numbers=false,$col_letters=false);
}
